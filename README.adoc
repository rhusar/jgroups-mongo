...
To provision in WildFly, use the following guide in the https://docs.wildfly.org/41/High_Availability_Guide.html#external-protocols[High Availability Guide → External Protocols].
